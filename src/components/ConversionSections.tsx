      ...
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[2.75rem] border border-zinc-200 bg-white shadow-[0_30px_90px_rgba(24,24,27,0.10)]">
        <div className="grid lg:grid-cols-[0.86fr_1.14fr]">
          <div className="relative isolate bg-zinc-950 p-8 text-white sm:p-12 lg:p-14">
            <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_18%_20%,rgba(234,108,36,0.28),transparent_34%),radial-gradient(circle_at_92%_88%,rgba(226,232,240,0.18),transparent_28%)]" />
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-orange-200">Método de compra</p>
            ...
            <a href="/shop" className="mt-9 inline-flex rounded-full bg-white px-6 py-3 text-sm font-semibold text-zinc-950 transition hover:-translate-y-1 hover:bg-orange-50">
              Abrir Shop completo
            </a>
          </div>
      ...
      <section id="consultoria" className="scroll-mt-28 px-5 py-20 lg:px-8">
        <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2.5rem] border border-zinc-200 bg-white shadow-2xl lg:grid-cols-[1fr_0.85fr]">
          <div className="p-8 sm:p-12 lg:p-16">
            <div className="mb-8 inline-flex items-center gap-2 rounded-full bg-orange-50 px-4 py-2 text-sm font-semibold text-orange-700">
          ...
          <div className="relative min-h-80 bg-[linear-gradient(135deg,#f8fafc,#ffedd5_42%,#18181b)]">
  ...
  return (
    <section id="contato" className="scroll-mt-28 px-5 py-20 lg:px-8">
      <div className="mx-auto grid max-w-7xl gap-10 rounded-[2.5rem] bg-zinc-100 p-6 sm:p-10 lg:grid-cols-[0.82fr_1fr] lg:p-14">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.25em] text-orange-600">Contato comercial</p>
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <label className="text-sm font-semibold text-zinc-700">
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-2xl border border-zinc-200 bg-white px-4 py-3 text-zinc-950 outline-none transition focus:border-orange-400 focus:ring-4 focus:ring-orange-100"
